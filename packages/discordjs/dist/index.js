...
var Discolytics = class {
  constructor(data) {
    ...
    this.core = new import_core.Discolytics(__spreadProps(__spreadValues({}, data), {
      clientType: import_core.ClientType.DISCORD_JS,
      auth: this.token,
  ...
  mapShardStatus(status) {
    switch (status) {
      case import_discord.Status.Connecting:
        return "connecting";
      case import_discord.Status.Reconnecting:
        return "reconnecting";
      case import_discord.Status.Resuming:
        return "resuming";
      case import_discord.Status.Ready:
        return "ready";
      default:
        return "disconnected";
    }
